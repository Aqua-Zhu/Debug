                ...
                <div id="body">
                    ...
                    <main>
                        ...
                        <section id="first-space">
                            <header id="banner-B" /*ref={bannerRef}*/>
                                <figure id="banner"><img src="./images/banner.jpg" alt="craftopia橫幅" /></figure>
                                <figure className="blob-1"><img src="./images/blob-1.svg" alt="" /></figure>
                                <figure className="blob-2"><img src="./images/blob-2.svg" alt="" /></figure>
                                <figure className="blob-3"><img src="./images/blob-3.svg" alt="" /></figure>
                                <figure className="blob-4"><img src="./images/blob-4.svg" alt="" /></figure>
                            ...
                            <section id="lesson">
                                ...
                                <figure id="tool"><img src="./images/線條圖_定規.png" alt="" /></figure>
                                <figure id="title-2"><img src="./images/title-choice-lesson.png" alt="" /></figure>
                                <figure className="blob-5"><img src="./images/blob-5.svg" alt="" /></figure>
                        ...
                        <header>
                            ...
                            <p className="btn-classes"><Seemore text={'All class'} imgBall={"./images/Vector-circle-b.png"} href={"https://www.google.com/webhp?hl=zh-TW&sa=X&ved=0ahUKEwjj157UwJnmAhVkL6YKHdSeA5IQPAgH"} /></p>
                        </header>
                        <section id="choice">
                            <div className="arr1">
                                <article id="cho-1">
                            ...
                            {/* 裝飾物件 */}
                            <figure id="tool-2"><img src="./images/實心圖_鉅弓.png" alt="" /></figure>
                            <figure id="tool-3"><img src="./images/線條圖_皮革順邊.png" alt="" /></figure>
                        ...
                        <section id="activity">
                            <div id="act-bg">
                                <header>
                                    <figure className="title"><img src="./images/title-activity.png" alt="" /></figure>
                                </header>
                                <article>
                                    <div className="act">
                            ...
                            <figure id="tool-4"><img src="./images/線條圖_夾子.png" alt="" /></figure>
                            <figure className="line-3"><img src="./images/line-3.png" alt="" /></figure>
                            <p className="Info-btn" href=""><Seemore text={'All Info'} imgBall={"./images/Vector-circle-b.png"} href={"https://www.google.com/webhp?hl=zh-TW&sa=X&ved=0ahUKEwjj157UwJnmAhVkL6YKHdSeA5IQPAgH"} /></p>
                        </section>
                        {/* 關於我們 */}
